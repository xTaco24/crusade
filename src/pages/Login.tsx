        ...
        <motion.div variants={stagger} initial="hidden" animate="show" className="w-full max-w-md">
          <GlassCard className="px-6 py-6 sm:px-8 sm:py-8">
            ...
            <motion.div variants={fadeInUp} className="text-center">
              ...
              <p className="mt-1 text-sm text-gray-300">Accede para participar en las elecciones</p>
            </motion.div>
            ...
            <motion.form variants={fadeInUp} className="mt-6 space-y-4" onSubmit={handleSubmit(onSubmit)}>
              ...
              >
                {isSubmitting ? <LoadingSpinner size="sm" /> : (<><LogIn className="h-5 w-5" /> Iniciar sesión</>)}
              </button>

              <div className="text-center text-sm">
                <Link to="/register" className="text-blue-300 hover:text-blue-200">¿No tienes cuenta? Crear una nueva</Link>
              </div>
            </motion.form>
          </GlassCard>
        </motion.div>
